...
<style type="text/css" id="form-designer-style">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line form-col-1" data-type="control_birthdate" id="id_24">
        ...
        <div id="cid_24" class="form-input-wide" data-layout="full" style="margin-bottom: 10px;">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="date" id="periodeDari" name="periodeDari" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 family-name" size="15" value="" data-component="last" aria-labelledby="label_4 sublabel_4_last" />
              <label class="form-sub-label" for="last_4" id="sublabel_4_last" style="min-height:13px" aria-hidden="false"> Periode Tanggungan </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <label class="form-sub-label" for="last_4" id="sublabel_4_last" style="min-height:13px; text-align: center;" aria-hidden="false"> Sampai Dengan </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="date" id="periodeSampai" name="periodeSampai" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 family-name" size="15" value="" data-component="last" aria-labelledby="label_4 sublabel_4_last" />
              <label class="form-sub-label" for="last_4" id="sublabel_4_last" style="min-height:13px" aria-hidden="false">  </label>
            </span>
          </div>
        </div>
      </li>
      ...
      <div style="padding-bottom: 25px; padding-left: 5px;">
  ...
  <script type="text/javascript">
    ...
    var nilaiAset = document.getElementById('nilaiAset');
		nilaiAset.addEventListener('keyup', function(e){
			// tambahkan 'Rp.' pada saat form di ketik
			// gunakan fungsi formatRupiah() untuk mengubah angka yang di ketik menjadi format angka
			nilaiAset.value = formatRupiah(this.value, 'Rp. ');
		});
    
    var biayaLainnya = document.getElementById('biayaLainnya');
		biayaLainnya.addEventListener('keyup', function(e){
			biayaLainnya.value = formatRupiah(this.value, 'Rp. ');
		});
    ...
    var asuransiTunai = document.getElementById('asuransiTunai');
		asuransiTunai.addEventListener('keyup', function(e){
			asuransiTunai.value = formatRupiah(this.value, 'Rp. ');
		});
    
    var discAngsuran = document.getElementById('discAngsuran');
		discAngsuran.addEventListener('keyup', function(e){
			discAngsuran.value = formatRupiah(this.value, 'Rp. ');
		});
    
    var rentalAmount = document.getElementById('rentalAmount');
		rentalAmount.addEventListener('keyup', function(e){
			rentalAmount.value = formatRupiah(this.value, 'Rp. ');
		});
    
    var biayaAdm = document.getElementById('biayaAdm');
		biayaAdm.addEventListener('keyup', function(e){
			biayaAdm.value = formatRupiah(this.value, 'Rp. ');
		});
    ...
    var stnk = document.getElementById('stnk');
		stnk.addEventListener('keyup', function(e){
			stnk.value = formatRupiah(this.value, 'Rp. ');
		});
    ...
    function checkKodeKontrak() {
      var getKodeKontrakStr = document.getElementById("kodeKontrak").value;
      var getbpkbPosition = document.getElementById("bpkbPosition");
      var getpositionDate = document.getElementById("positionDate");
      var getdocNumber = document.getElementById("docNumber");

      if(getKodeKontrakStr == "E" || getKodeKontrakStr == "F") {
        getbpkbPosition.disabled = false;
        getpositionDate.disabled = false;
        getdocNumber.disabled = false;
      }
      else {
        getbpkbPosition.disabled = true;
        getbpkbPosition.value = "";
        getpositionDate.disabled = true;
        getpositionDate.value = "";
        getdocNumber.disabled = true;
        getdocNumber.value = "";
      }
    }

    function checkAsuransi() {
      var getPeriodeDari = document.getElementById("periodeDari");
      var getPeriodeSampai = document.getElementById("periodeSampai");
      var getTanggunganSatu = document.getElementById("tanggunganSatu");
      var getTanggunganDua = document.getElementById("tanggunganDua");
      var getTanggunganTiga = document.getElementById("tanggunganTiga");
      var getTanggunganEmpat = document.getElementById("tanggunganEmpat");
      var getTanggunganLima = document.getElementById("tanggunganLima");
      var getTanggunganEnam = document.getElementById("tanggunganEnam");
      var getTjh = document.getElementById("tjh");
      var getTsi = document.getElementById("tsi");
      var getTsiDriver = document.getElementById("tsiDriver");
      var getTsiPassenger = document.getElementById("tsiPassenger");

      if(asuransiNo.checked) {
        getPeriodeDari.disabled = true;
        getPeriodeDari.value = " ";

        getPeriodeSampai.disabled = true;
        getPeriodeSampai.value = " ";

        getTanggunganSatu.disabled = true;
        getPeriodeDari.value = " ";

        getTanggunganDua.disabled = true;
        getTanggunganDua.value = " ";

        getTanggunganTiga.disabled = true;
        getTanggunganTiga.value = " ";

        getTanggunganEmpat.disabled = true;
        getTanggunganEmpat.value = " ";

        getTanggunganLima.disabled = true;
        getTanggunganLima.value = " ";

        getTanggunganEnam.disabled = true;
        getTanggunganEnam.value = " ";

        getTjh.disabled = true;
        getTjh.value = "";

        getTsi.disabled = true;
        getTsi.value = "";

        getTsiDriver.disabled = true;
        getTsiDriver.value = "";

        getTsiPassenger.disabled = true;
        getTsiPassenger.value = "";
      }

      else if(asuransiYes.checked) {
        getPeriodeDari.disabled = false;
        getPeriodeSampai.disabled = false;
        getTanggunganSatu.disabled = false;
        getTanggunganDua.disabled = false;
        getTanggunganTiga.disabled = false;
        getTanggunganEmpat.disabled = false;
        getTanggunganLima.disabled = false;
        getTanggunganEnam.disabled = false;
        getTjh.disabled = false;
        getTsi.disabled = false;
        getTsiDriver.disabled = false;
        getTsiPassenger.disabled = false;
      }
    }

    function checkRate() {
      var getFlatRate = document.getElementById("flatRate").value;
      var getDecliningRate = document.getElementById("decliningRate").value;
      var getOverdueRate = document.getElementById("overdueRate").value;
      var getRebateRate = document.getElementById("rebateRate").value;
      var getRentalAmount = document.getElementById("rentalAmount").value;
      var getAdvArv = document.getElementById("advArv").value;
      
      var getKodeKontrakStr = document.getElementById("kodeKontrak").value;

      if(getAdvArv == "R") {
        if(getKodeKontrakStr == "S") {
          if(getFlatRate < 12.49521048) {
            sweetAlert('Data tidak valid!','Flat rate minimal 12.49521048!','error')
          }
          else {
            sweetAlert('Success!','Rate normal!','success')
          }
        }
        else {
          if(getFlatRate < 7.0) {
            sweetAlert('Data tidak valid!','Flat rate minimal 7.0!','error')
          }
          else {
            sweetAlert('Success!','Rate normal!','success')
          }
        ...
        if(getKodeKontrakStr == "S") {
          if(getFlatRate < 11.67014668) {
            sweetAlert('Data tidak valid!','Flat rate minimal 11.67014668!','error')
          }
          else {
            sweetAlert('Success!','Rate normal!','success')
          }
          ...
          if(getFlatRate < 6.96) {
            sweetAlert('Data tidak valid!','Flat rate minimal 6.96!','error')
          }
          else {
            sweetAlert('Success!','Rate normal!','success')
          }
      ...
      if(getRentalAmount == 0 || getRentalAmount == null) {
        sweetAlert('Data tidak valid!','Rental amount tidak boleh kosong!','error')
      }
    }
